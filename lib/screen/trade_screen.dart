...
import 'package:raccoon_investment/widget/base/datepicker.dart';
...
class TradeScreen extends StatefulWidget {
  ...
  static Route<void> route(Trade trade) {
    return MaterialPageRoute(builder: (context) => TradeScreen(trade: trade));
  }
...
class _TradeScreenState extends State<TradeScreen> {
  ...
  void initState() {
    ...
    if (widget.trade != null) return;

    dateController.text = widget.trade!.date;
    priceController.text = widget.trade!.price.toString();
    countController.text = widget.trade!.count.toString();
    commissionController.text = widget.trade!.commission.toString();
    textController.text = widget.trade!.text;

    setState(() {
      type = widget.trade!.type;
    });
  }
        ...
        children: [
          BlocConsumer<TradeBloc, TradeState>(
            listenWhen: (previous, current) {
              return previous.status.isLoading && current.status.isSuccess;
            },
